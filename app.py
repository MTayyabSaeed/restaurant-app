...
def restaurant_menu(restaurant_id):
    ...
    if menu_items:
        return render_template('restaurantmenu.html', restaurant=restaurant, menu_items=menu_items)
    else:
        return "No Menus Found"

@app.route('/restaurants/<int:restaurant_id>/create-menu-item/', methods=['GET', 'POST'])
...
@app.route('/restaurants/<int:restaurant_id>/<int:menu_id>/edit-menu-item/', methods=['GET', 'POST'])
